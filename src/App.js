  ...
  let routers = createBrowserRouter([
    {
      path: '', element: <Layout user={user} setUser={setUser} />, children: [
        { index: true, element: <Prodected > <Spinner /> </Prodected>},
        { path: 'register', element: <Register /> },
        { path: 'contact', element: <Cont /> },
        { path: 'login/register', element: <Register /> },
        { path: 'main', element: <Prodected ><Main /> </Prodected> },
        ...
        { path: 'Tesla', element: <Prodected><Tesla /></Prodected> },
        ...
        { path: 'Temperature', element: <Prodected><Temperature /></Prodected> },
